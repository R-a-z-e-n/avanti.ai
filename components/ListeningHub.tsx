...
import { getGeminiClient, decodeBase64, decodeAudioData } from '../services/geminiService';
  ...
  const fetchScenario = async (packId: string) => {
    ...
    try {
      const response = await ai.models.generateContent({
        ...
        contents: `Generate a natural dialogue or scene in ${language} at ${pack.level} level (about 4 sentences). Theme: ${pack.name}. Return only text.`,
      });
